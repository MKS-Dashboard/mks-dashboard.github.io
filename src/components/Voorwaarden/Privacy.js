...
const Privacy = () => {
    ...
    return (
        <div id="Container">
            ...
            <p>
                MKS-Dashboard en/of ander aanverwante services die MKS-Dashboard aanbied,
                gelegen op/gekoppeld aan https://mks-dashboard.github.io/, is verantwoordelijk voor de verwerking van gegevens. Zoals weergeven in deze privacyverklaring
            </p>

            <h2>Persoonsgegevens die wij verwerken:</h2>
            <p>
                MKS-Dashboard verwerkt je persoonsgegevens doordat je gebruik maakt van onze diensten en/of omdat je deze gegevens zelf aan ons verstrekt. Hieronder vind je een overzicht van de persoonsgegevens die wij verwerken:
                <ul>
            ...
            <p>
                ...
                neem dan contact met ons op via centralistpiet2001@gmail.com, dan verwijderen wij deze informatie.
            </p>

            <h2>Met welk doel en op basis van welke grondslag wij persoonsgegevens verwerken</h2>
            <p>
                MKS-Dashboard verwerkt jouw persoonsgegevens voor de volgende doelen:
                <ul>
                    <li>Om goederen en diensten bij je af te leveren</li>
                    <li>MKS-Dashboard analyseert jouw gedrag op de website om daarmee de website te verbeteren en het aanbod van producten en diensten af te stemmen op jouw voorkeuren.</li>
                </ul>
            </p>
            ...
            <p>
                MKS-Dashboard verstrekt uitsluitend aan derden en alleen als dit nodig is voor de uitvoering van onze overeenkomst met jou of om te voldoen aan een wettelijke verplichting.
            </p>

            <h2>Cookies, of vergelijkbare technieken, die wij gebruiken</h2>
            <p>
                MKS-Dashboard gebruikt alleen technische en functionele cookies.
            ...
            <p>
                ...
                of bezwaar te maken tegen de verwerking van jouw persoonsgegevens door MKS-Dashboard
                en heb je het recht op gegevensoverdraagbaarheid.
                Dat betekent dat je bij ons een verzoek kan indienen om de persoonsgegevens die wij van jou beschikken
                in een computerbestand naar jou of een ander,
                ...
                sturen naar centralistpiet2001@gmail.com. Om er zeker van te zijn dat het verzoek tot inzage door jou is gedaan,
                dien je ons je UserID van het spel mee te sturen. Wij zullen u via deze weg een verificatie code sturen welke u in de mail ons moet toezenden om de gegevens te krijgen.
